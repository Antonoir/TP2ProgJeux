...
namespace platformer
{
	...
	public:
		...
		bool requeteModifCompte(Textbox username, Textbox password, Textbox name, Textbox firstname, Textbox email);
		...
		void requeteModifInfoCompte(Textbox& name, Textbox& firstname, Textbox& email);
		...
		bool requeteCreerModif(const Textbox& textfirstname, const Textbox& textlastname, const Textbox& textemail);
	private:
		Controleur();
